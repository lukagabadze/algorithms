...
if __name__ == '__main__':
    ...
    if compare["bubble"]:
        ...
        end_time = time.time()
        print(f"Time taken to BUBBLE sort a list of {
    ...
    if compare["insertion"]:
        ...
        end_time = time.time()
        print(f"Time taken to INSERTION sort a list of {
              list_size} elements: {end_time - start_time:.6f} seconds")
    ...
    if compare["selection"]:
        ...
        end_time = time.time()
        print(f"Time taken to SELECTION sort a list of {
              list_size} elements: {end_time - start_time:.6f} seconds")
    ...
    if compare["merge"]:
        ...
        end_time = time.time()
        print(f"Time taken to MERGE sort a list of {
              list_size} elements: {end_time - start_time:.6f} seconds")
    ...
    if compare["quick"]:
        ...
        end_time = time.time()
        print(f"Time taken to QUICK sort a list of {
              list_size} elements: {end_time - start_time:.6f} seconds")
