...
NOTE: I just ran the DFS solution again and it gave back 56ms, before it was 61ms (3ms longer than BFS).
"""
...
class Solution(object):
    def longestZigZag(self, root):
        ...
        answer = 0
        while queue:
            (node, direction, depth) = queue.pop()
